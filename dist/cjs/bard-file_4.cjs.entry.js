...
const UploadedFile = class {
    ...
    constructor(hostRef) {
        ...
        this.removeEvent = index.createEvent(this, "uploaded-file:remove", 7);
        this.name = undefined;
    ...
    render() {
        return (index.h(index.Host, null, index.h("slot", null), index.h("figure", null, index.h("div", { class: "progress-details" }, index.h("progress-bar", { percent: this.percent, class: this.state }, index.h("a", { class: "download-link", href: this.src, download: this.filename, onClick: e => e.stopPropagation() }, this.filename)), index.h("span", { class: "progress-icon" }), index.h("a", { class: "remove-media", onClick: this.removeClicked, href: "#" }, index.h("span", null, "Remove media"))), this.preview ? index.h("file-preview", { src: this.src, filetype: this.filetype }) : '')));
    }
    componentDidRender() {
...
const BardFile = class {
    ...
    // Rendering
    render() {
        return (index.h(index.Host, null, index.h("file-drop", { for: this.fileTargetId, onClick: () => this.fileTarget.click() }, index.h("p", { part: "title" }, index.h("strong", null, "Choose ", this.multiple ? "files" : "file", " "), index.h("span", null, "or drag ", this.multiple ? "them" : "it", " here.")), index.h("div", { class: `media-preview ${this.multiple ? '-stacked' : ''}` }, index.h("slot", null)))));
    }
    componentDidRender() {
...
//# sourceMappingURL=bard-file_4.cjs.entry.js.map