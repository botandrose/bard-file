...
const UploadedFile = class {
    ...
    constructor(hostRef) {
        ...
        this.removeEvent = index.createEvent(this, "uploaded-file:remove");
        this.uid = uid++;
    ...
    render() {
        return (index.h(index.Host, { key: 'fcfc0f35f9ea1709fa64840c6e72ad078a67a630' }, index.h("slot", { key: 'd71052b9e2aa323eeecbf86296e20e9c4df3acf4' }), index.h("figure", { key: 'aa373e5ded54689c29d07505b19f629a1d687029' }, index.h("div", { key: '7e84b497f44ad9362c866d30b7a044a44307cbd4', class: "progress-details" }, index.h("progress-bar", { key: '6775ae55eed138754d8d66e9e2b2d6e0bb477c59', percent: this.percent, class: this.state }, index.h("a", { key: 'd3f489b8930818c06132ba93a69875409277dbb3', class: "download-link", href: this.src, download: this.filename, onClick: e => e.stopPropagation() }, this.filename)), index.h("span", { key: '25c6d686db7df4b80e3bfbdcd62ef75bd8c66be5', class: "progress-icon" }), index.h("a", { key: 'e397f1139d7e565a8aacb35955fe79a2a2bd746d', class: "remove-media", onClick: this.removeClicked, href: "#" }, index.h("span", { key: '91617315ad71b68fa6e98e1cae979ed1450f96ba' }, "Remove media"))), this.preview ? index.h("file-preview", { src: this.src, filetype: this.filetype }) : '')));
    }
    componentDidRender() {
...
const BardFile = class {
    ...
    // Rendering
    render() {
        return (index.h(index.Host, { key: 'ab3a5bae8e654113956ee0eb467443dcdb0adb1a' }, index.h("file-drop", { key: 'ae3c0de783a09f595ab64ac447908e11b4e2a712', for: this.fileTargetId, onClick: () => this.fileTarget.click() }, index.h("p", { key: '2d68ab77057e2cf0520d2da17f6b5185568baf33', part: "title" }, index.h("strong", { key: '31718028c7aee521f3f79ad5d2b975ed9e9732ce' }, "Choose ", this.multiple ? "files" : "file", " "), index.h("span", { key: 'ef5d6e2aff3e4d460ce4319a14f33dceac9a836b' }, "or drag ", this.multiple ? "them" : "it", " here.")), index.h("div", { key: 'a03c162469b324f159934de66dbc813f16b4bbf6', class: `media-preview ${this.multiple ? '-stacked' : ''}` }, index.h("slot", { key: '7b03028a371dafa4513594134fc55a222ea6e6cc' })))));
    }
    componentDidRender() {
...
const FilePreview = class {
    ...
    filetype;
    render() {
        return (index.h(index.Host, { key: '4ac011f2a5a1d7d9130f86014351513b9a42f843', class: this.computeClass() }, this.isImage() && index.h("img", { key: '7a169a7185eb1494a61a7b3c0f628f9a214bcb39', src: this.src }), this.isVideo() && index.h("video", { key: 'cd8b3414f65e19a24f8c2ccb55606c7b01fd31ff', src: this.src, onClick: toggle }), this.isOther() && "This file does not offer a preview", index.h("slot", { key: 'de543ee7457c0685666ed8acac67ba7d2e3631ed' })));
    }
    computeClass() {
        if (this.isImage())
            return "image";
...
exports.bard_file = BardFile;
exports.file_preview = FilePreview;
exports.uploaded_file = UploadedFile;
//# sourceMappingURL=bard-file.file-preview.uploaded-file.entry.cjs.js.map
