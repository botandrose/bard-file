...
import { d as defineCustomElement$1 } from './attachment-preview2.js';
...
const AttachmentFile = /*@__PURE__*/ proxyCustomElement(class AttachmentFile extends HTMLElement$1 {
    ...
    render() {
        return (h(Host, { key: '2ea464eeb47fc7701df64b3485842c19052fe013' }, h("slot", { key: 'efed24529b26f2c403c62693433b433036958506' }), h("figure", { key: '67243afd9385c7c6fd35c1801fce14b884e23b15' }, h("div", { key: 'f6fe7af396ccd7d9abf82cc515818e1de4bfed6b', class: "progress-details" }, h("progress-bar", { key: '44dc82fb2fcd9fde89e4a4bfe88b2a9e933fe835', percent: this.percent, class: this.state }, h("a", { key: '196c49132af704e2a5e4811a479cea795ecdf29d', class: "download-link", href: this.src, download: this.filename, onClick: e => e.stopPropagation() }, this.filename)), h("span", { key: '4686ab8a7c166d8e2a23941626df07d51ef410ad', class: "progress-icon" }), h("a", { key: '128e827982fa22560cba62e003a2c1f9a8e30cfe', class: "remove-media", onClick: this.removeClicked, href: "#" }, h("span", { key: 'ec1eccea98af3d5ca03cacba5b5eb6cc12b23284' }, "Remove media"))), this.preview ? h("attachment-preview", { src: this.src, filetype: this.filetype }) : '')));
    }
    componentDidRender() {
    ...
    static get style() { return attachmentFileCss; }
}, [257, "attachment-file", {
        "name": [1537],
        "accepts": [1537],
        "max": [1538],
...
function defineCustomElement() {
    ...
    const components = ["attachment-file", "attachment-preview"];
    components.forEach(tagName => { switch (tagName) {
        case "attachment-file":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AttachmentFile);
            }
            break;
...
export { AttachmentFile as A, arrayRemove as a, defineCustomElement as d, html as h, morphdom as m };
//# sourceMappingURL=attachment-file2.js.map
