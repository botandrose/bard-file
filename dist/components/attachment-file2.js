...
const AttachmentFile = /*@__PURE__*/ proxyCustomElement(class AttachmentFile extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '250f95904833749fd8e0a0a14b0662fc6967f372' }, h("slot", { key: '1ef8e8fe1bc936eb0bd8f93e8d914b165e5fb7a4' }), h("figure", { key: '8925a0e6e51b8635dbd2b503a799082b8ffcf470' }, h("div", { key: '2e4110bf466da700c51be7798542a59a83ad8e2b', class: "progress-details" }, h("progress-bar", { key: '80472e9ca39fffe692f667752fb338c955f727d8', percent: this.percent, class: this.state }, h("a", { key: '0e3fe2962285522f2ce56443ad0c28841e89102f', class: "download-link", href: this.src, download: this.filename, onClick: e => e.stopPropagation() }, this.filename)), h("span", { key: '50a78d623d9ec2d19701db772c4e567bd961551a', class: "progress-icon" }), h("a", { key: '48a8fbac385e4dd9ed8a2e3abd8e0ae270985571', class: "remove-media", onClick: this.removeClicked, href: "#" }, h("span", { key: 'f30693e11dfb830ad014d741b3916ce69f4db4d2' }, "Remove media"))), this.preview ? h("attachment-preview", { src: this.src, filetype: this.filetype }) : '')));
    }
    componentDidLoad() {
...
export { AttachmentFile as A, defineCustomElement as d };
